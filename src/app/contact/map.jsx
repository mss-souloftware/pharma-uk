...
const Map = () => {
    ...
    <> 
      ...
      <div className="container mx-auto md:mb-[70px] lg:px-8">
        <div className="grid w-full h-auto gap-4 p-0 relative">
          ...
          <h1 className="block ml-2 xl:ml-0 justify-start text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-center sm:text-start xl:text-left">
              Company&nbsp;
  ...
  <p className="w-full lg:w-72 max-w-full sm:text-left text-center leading-8 sm:leading-10 bg-gray-100 sm:bg-transparent text-base sm:text-base lg:text-lg xl:text-xl font-medium sm:mb-4 mb-0 ">
    ...
    we have built a reputation for being a trusted name in the UK.
                ...
                {/* Map Section */}
                <div className="md:mt-7 w-full relative order-1 lg:order-2 border-2 border-hoverUnderlineColor rounded-xl">
                  <iframe
                    ...
                    className="w-full rounded-xl border-hoverUnderlineColor  "
                    height="350"
