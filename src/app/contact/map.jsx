...
const Map = () => {
    ...
    <> 
      ...
      <div className="container mx-auto mb-[70px] px-4 sm:px-6 lg:px-8">
        <div className="grid w-full h-auto gap-4 p-0 relative">
          ...
          <h1 className="block ml-2 xl:ml-0 justify-start text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-center xl:text-left">
              Company&nbsp;
  ...
  <p className='w-full sm:w-3/4 lg:w-72 max-w-full sm:text-left text-center leading-10 bg-gray-100 sm:bg-transparent xl:text-base md:text-sm text-xs font-normal'>
    ...
    we have built a reputation for being a trusted name in the UK.
                ...
                {/* Map Section */}
                <div className="mt-7 w-full relative order-1 lg:order-2 border-2 border-hoverUnderlineColor rounded-xl">
                  <iframe
