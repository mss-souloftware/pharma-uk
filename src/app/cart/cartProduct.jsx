    ...
    <tr className="border border-gray-300">
      ...
      <td className="p-4 text-center">
        <div className="flex justify-center items-center gap-2">
          <button
            className="bg-gray-200 px-3 py-1 rounded-l-md hover:bg-[#30BFAC] hover:text-white"
            onClick={onDecrease}
          ...
          <button
            className="bg-gray-200 px-3 py-1 rounded-r-md hover:bg-[#30BFAC] hover:text-white"
            onClick={onIncrease}
          >
            +
          </button>
