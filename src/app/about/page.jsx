      ...
      <div className="container mx-auto mb-[70px] ">
        <div className="grid  w-full h-auto gap-2 p-0 relative">
          ...
          <div className="w-full my-8">
            ...
            <div className="grid grid-rows-2 sm:grid-cols-1 lg:grid-cols-[30%_70%] lg:grid-rows-1 gap-y-4 sm:gap-y-2 h-auto lg:h-72">
  {/* Text Section */}
  <div className="mt-7 order-2 lg:order-1">
          ...
          <div className="  bg- text-white py-14">
            ...
            <div className=" left-0 block tracking-wide space-y-1">
              ...
              >
                ...
                Pharmica is: Ana Carolina Osorio De Faria Goncalves GPhC Number:
                2088658
              </p>
