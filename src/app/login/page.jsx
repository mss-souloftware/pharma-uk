    ...
    <section className="min-h-screen flex items-center justify-center dark:bg-gray-900">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg dark:bg-gray-800 p-6">
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 mt-4">
          <button onClick={() => router.push('/forgotPassword ')} className="text-[#1AB8A3]">Forgot Password?</button>
        </p>

        <p className="text-center text-gray-600 dark:text-gray-400 mt-4">
          Don't have an account? <Link href="/signUp" className="text-[#1AB8A3]">Sign Up</Link>
        </p>
