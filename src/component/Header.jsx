          ...
          <div className="phone-email-section sm:ml-3 text-nowrap gap-5 lg:gap-12 md:gap-10 sm:text-xs text-xs md:text-sm flex items-center justify-around">
            ...
            <div ref={phoneRef} className="flex justify-center">
              <Image
                ...
                width={20}
                height={20}
                className="ml-1 mr-1 md:ml-0 mt-1 md:mr-2 sm:mt-1 object-contain sm:w-3 md:w-4 lg:w-5 w-3"
              />
            ...
            <div ref={emailRef} className="flex justify-center">
              <Image
                ...
                width={20}
                height={20}
                className="mr-1 md:mr-2 mt-1 sm:w-3 object-contain md:w-4 lg:w-5 w-3"
              />
              <span className="text-white mt-1 font-normal text-xs sm:text-sm md:text-base lg:text-lg">
