...
const Header = () => {
  return ( 
     <div className="bg-hoverUnderlineColor">
       <div className="flex container mx-auto md:justify-between  bg-hoverUnderlineColor md:p-4 p-2 ">
        ...
        <div className="phone-email-section sm:ml-3 text-nowrap gap-5 lg:gap-12 md:gap-10 sm:text-xs text-xs md:text-sm flex items-center justify-around  ">
          <div className="flex justify-center">
            <img
              src="/phone-icon.png"
              alt="Phone"
              className=" ml-1 mr-1 md:ml-0 mt-1 md:mr-2 sm:mt-1 object-contain logoImg sm:w-3 md:w-3 lg:w-5 w-3 "
            />
          ...
          <div className="flex justify-center">
            <img
              src="/email-icon.png"
              alt="Email"
              className="mr-1 w-3 md:mr-2 mt-1 logoImg sm:w-3 object-contain  md:w-3  lg:w-5 w-3"
            />
