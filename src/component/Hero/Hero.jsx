...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="relative container z-20 flex flex-col justify-center md:justify-start md:left-0 xl:left-8 md:left-8  ">
        {/* Heading */}
        <h1
  ...
  <span className="text-left text-xs sm:text-sm md:text-base text-center leading-tight sm:ml-0 md:text-xs md:w-[100%] md:text-left   ">
    The Winner of the Feefo Platinum Trusted Service Award in 2024
        ...
        <div className="xl:mt-5 sm:mt-6 md:mt-4">
          <button className="xl:px-6 xl:py-3 md:px-6 md:py-1 mt-2 sm:w-[15%] w-[30vw] sm:h-[6vh] h-[8vh] sm:text-base text-xs bg-hoverUnderlineColor text-white font-semibold rounded-lg shadow-lg  hover:bg-hoverUnderlineColor transition-all  transition ease-in-out delay-15 bg-hoverUnderlineColor
