    ...
    >
      ...
      <div className="relative container z-20 sm:ml-6 md:ml-0 flex flex-col text-center sm:text-left justify-center md:justify-start md:left-8">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white ">
          ...
          <span className=" xl:text-5xl md:text-3xl ">
            with quality medicine
          </span>
        </h1>

        <div className="heroSubText grid container grid-cols-2 xl:text-base md:text-sm text-xs w-[100%] sm:w-[55%] md:w-[50%] lg:w-[45%] lg:grid-cols-2 gap-0 sm:gap-2 ml-0 sm:justify-center lg:ml-0  md:items-start sm:items-start  xl:w-[calc(100%-70%)] ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:w-[30%] md:w-[45%] sm:w-[55%] md:text-sm xl:text-base sm:grid-cols-2 gap-2 md:gap-0 border-2 border-solid border-transparent mt-px-2 sm:px-1">
          ...
          <div className="flex flex-col space-y-2 sm:space-y-2 justify-center items-center sm:items-start md:w-36">
            ...
            {
              [...Array(5)].map((_,index)=>(
                <Image key={index} src="/icons/star.png" height={20} width={29} alt="star-icon" className="w-4 sm:w-4 md:w-5" />
              ))
            }
            </div>
          </div>
